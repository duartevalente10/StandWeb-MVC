...
namespace StandWeb.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdReview,Comentario,Pontuacao,Data,UtilizadoresFK,CarrosFK")] Reviews reviews)
        {
            ...
            ViewData["CarrosFK"] = new SelectList(_context.Carros, "IdCarros", "Foto", reviews.CarrosFK);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdReview,Comentario,Pontuacao,Data,UtilizadoresFK,CarrosFK,Visibilidade")] Reviews reviews)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Details), "Carros", new { id = reviews.CarrosFK });
        }
